...
void TraceEffect::Ini(Vec3 pos)
{
	...
	//スケール
	std::uniform_real_distribution<float> sclDistX(0.4f, 0.6f);
	std::uniform_real_distribution<float> sclDistY(0.4f, 0.6f);
	std::uniform_real_distribution<float> sclDistZ(0.4f, 0.6f);
